                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex gap-2 flex-wrap-wrap">
                                            <Button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#calculate-modal">Calculate</Button>
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label" for="inlineCheckbox1"><strong>Pickup</strong></label>
                                        </div>
                                </div>
                            </div>
                        </div>
                        <div class=" col-md-6">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <div class="form-check form-check-inline">
                                            <input class="form-check-input" checked type="checkbox" id="inlineCheckbox1" value="option1">
                                            <label class="form-check-label" for="inlineCheckbox1"><strong>Drop</strong></label>
                                        </div>
                                </div>
                            </div>
                        </div>
