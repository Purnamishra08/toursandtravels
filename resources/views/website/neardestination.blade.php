...
{!! json_encode([
    ...
    "itemListElement" => [
        ...
        [
            ...
            "position" => 2,
            "name" => "Place",
            "item" => route('website.neardestination', ['slug' => $placesData->place_url])
        ]
    ]
                ...
                <div class="container" id="overview">
                        <div class="section-title-container wow animate__fadeInUp  " data-wow-delay="200ms">
                            <div>
                                ...
                                <h2 class="section-title">{{isset($placesData) ? $placesData->place_name : ''}} Overview</h2>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                <div class="client-details mb-2">
                                    <div class="d-flex gap-2 align-items-center">
                                        ...
                                        <div>
                                            <p class="client-name">{{isset($reviews) ? $reviews->reviewer_name : ''}}</p>
                                            @php
                                                $rating = 0;
                                                if(isset($reviews) && !empty($reviews->no_of_star)){
                                        ...
                                        <p class="client-location text-secondary"><svg class="svg-inline--fa fa-location-dot" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="location-dot" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" data-fa-i2svg="">
                                            ...
                                            </svg>{{isset($reviews) ? $reviews->reviewer_loc : ''}}</p>
                                    </div>
                                    @if(isset($reviews) && !empty($reviews->feedback_msg))
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content ">
                ...
                <div class="modal-body text-center">
                    <h1 class="my-3">Planning a Trip to {{isset($placesData) ? $placesData->place_name : ''}} ?</h1>
