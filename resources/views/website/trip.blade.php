...
<div class="breadcrumb-section" style="background-image: url('http://localhost:8000/storage/destination_images/avalanche-lake-ooty.webp');">
    <div class="container">
        <h1 class="page-name">Relax Coorg tour</h1>
        <ul class="breadcrumb-list">
            <li class="breadcrumb-item">
                <a href="{{route('website.home')}}" class="breadcrumb-link"><i class="bi bi-house"></i></a>
            </li>
            <li class="breadcrumb-item">
                <a href="{{route('website.allTourPackages')}}" class="breadcrumb-link active">Relax Coorg tour</a>
            </li>
        </ul>
    </div>
    ...
    <section>
        <div class="container">
            <div class="page-section ">
                <h1 class="page-section-heading">Relax Coorg tour</h1>
                <div class="about-content mb-3">
                    <div class="description-preview" style="max-height: 200px;overflow:hidden; position: relative;">
                        ...
                        <div class="description-full">
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam praesentium, consectetur perspiciatis ipsa, rerum reiciendis iure, nostrum est eos officia veritatis quas maiores illum enim numquam ipsum suscipit beatae amet at saepe nobis reprehenderit. Veritatis temporibus pariatur laudantium esse! Minus velit autem repellat. Non tempora culpa quis aspernatur tenetur laudantium maiores neque, facilis nihil, nam sit recusandae placeat, voluptatem maxime architecto sed? Autem, magni quis accusantium nam atque fuga delectus, esse vero et consequuntur quaerat, id repellendus sed deserunt illo voluptatibus! Tempora cumque et eum debitis totam doloribus ipsam nemo voluptas fugiat quae sint quod facere quibusdam, ducimus voluptates perferendis? Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloremque ullam velit libero, dignissimos maiores maxime dolore doloribus cupiditate atque? Ea ratione nostrum sequi animi accusamus aut, quia consectetur recusandae vitae quidem totam beatae rerum ipsum natus aperiam! Mollitia, nostrum repellat doloribus tempore ducimus eligendi ex quis corporis dignissimos! Libero perspiciatis illo impedit quaerat ullam ut, rem veniam deserunt cum nemo id sed facere est. Esse beatae amet aspernatur debitis corporis, dignissimos voluptatum similique mollitia iste rem qui! Consectetur, accusantium commodi. Recusandae, quae aspernatur! Sapiente libero sequi facere autem excepturi, earum vel magni veniam, tempora quam, dicta officiis perferendis! Laborum, reiciendis.</p>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="section-title-container wow animate__fadeInUp" data-wow-delay="200ms" style="visibility: visible; animation-delay: 200ms; animation-name: fadeInUp;">
                <div>
                    ...
                    <h2 class="section-title-sm"> 67 Best Relax Coorg Package Found.</h2>
            ...
            <div class="card-wrapper " id="allTour">
                ...
                <div class="card tour-card  wow animate__fadeInUp" data-wow-delay="200ms" style="visibility: visible; animation-delay: 200ms; animation-name: fadeInUp;">
                ...
                <div class="card tour-card  wow animate__fadeInUp" data-wow-delay="200ms" style="visibility: visible; animation-delay: 200ms; animation-name: fadeInUp;">
                    <img class="card-img-top" src="http://localhost:8000/storage/tourpackages/thumbs/edakkal-caves.webp" alt="edakkal caves"><span class="badge">Most popular</span>
                    <div class="card-body">
                        <p class="card-lavel">
                            <i class="bi bi-clock"></i> 4 days &amp; 3 Nights
                            <small class="d-block">Ex- Mysore</small>
                        </p>
                        ...
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            ...
                            <div class="p-card-info">
                                ...
                                <h6 class="mb-0"><span>₹ </span>15000.00 </h6>
                                <strike>₹ 18000.00</strike>
                            </div>
                            <a href="http://localhost:8000/tour/4-days-trip-from-mysore--coorg-wayanad--mysore" class="btn btn-outline-primary stretched-link">Explore <i class="ms-2 bi bi-arrow-right-short"></i></a>
                        </div>
                    </div>
                </div>
            </div>
