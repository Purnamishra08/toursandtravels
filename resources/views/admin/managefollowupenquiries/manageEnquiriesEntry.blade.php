                ...
                <main>
                    <div class="inner-layout">
                        <div class="container-fluid px-4 pt-3">
                            <nav class="tab-menu">
                                <a href="{{ route('admin.manageenquiriesentry.addEnquiriesEntry') }}" class="tab-menu__item">
                                ...
                                <a href="{{ route('admin.manageenquiriesentry') }}" class="tab-menu__item active">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <form action="{{ route('admin.managepackageenquiry') }}" method="POST" onsubmit="return validator()">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 form-group mb-sm-0">
                                            <label class="control-label">Created From Date</label>
                                        ...
                                        <div class="col-sm-4 form-group mb-sm-0">
                                            <label class="control-label">Created To Date</label>
...
$(document).ready(function () {
    ...
    function loadTable() {
        ...
        $('#enquiryEntryTable').DataTable({
            ...
            responsive: true,
            ajax: {
                url: "{{ route('admin.manageenquiriesentry') }}",
                type: 'GET',
                data: function (d) {
...
// Open Edit Modal
        $(document).on('click', '.view-btn', function () {
            ...
            $.ajax({
                url: '/viewEnquiriesEntry/' + sourceId,  // Fetch modal HTML via AJAX
                type: 'GET',
