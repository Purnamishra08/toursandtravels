                                ...
                                <a href="{{ route('admin.manageenquiriesreport') }}" class="tab-menu__item active">
                                 ...
                                 <!-- table-utilities -->
                                    <div class="table-utilities">
                                        <a href="{{ route('admin.exportEnquiries', request()->query()) }}" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Export CSV"><i class="fa-solid fa-file-csv"></i></a>
