...
<body>
                    ...
                    <div class="inner-layout">
                        <div class="container-fluid px-4 pt-3">
                            <nav class="tab-menu">
                                ...
                                <a href="{{ route('admin.packageType') }}" class="tab-menu__item active">
                                    <!-- <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                    ...
                                    <div class="col-sm-4">
                                        <div  style="margin-bottom: 25px;box-shadow: 0 3px 6px rgba(0, 0, 0, 0.16); background-color:#fff; padding:25px;border-radius: 4px;">
                                            <div class="panel-body">
                                                <form action="{{ route('admin.packageType.addPackageType') }}"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label>Package Type <span class="manadatory">*</span></label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="Enter Package Type" name="packageType"
                                                                    id="packageType">
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <script>
        function validator(){
        if(!blankCheck('packageType','Package Type cannot be Blank'))
        return false;
        }
        ...
        $('#sourceTable').DataTable({
            ...
            ajax: '{{ route('admin.packageType') }}', // Fetch data from controller
     ...
     // Open Edit Modal
        $(document).on('click', '.edit-btn', function () {
            ...
            $.ajax({
                url: '/packageType/edit/' + sourceId,  // Fetch modal HTML via AJAX
                type: 'GET',
        ...
        $(document).on('submit', '#editSourceForm', function (e) {
            ...
            $.ajax({
                url: '/packageType/update',  // Ensure correct URL
                type: 'POST',
                data: $(this).serialize(),
