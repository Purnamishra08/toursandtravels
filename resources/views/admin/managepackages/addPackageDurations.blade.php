                ...
                <main>
                    <div class="inner-layout">
                        <div class="container-fluid px-4 pt-3">
                            <nav class="tab-menu">
                                <a href="{{ route('admin.managepackagedurations.addPackageDurations') }}" class="tab-menu__item active">
                                    ...
                                    <div class="col-md-12">
                                        <div class="panel panel-bd lobidrag">
                                            <div class="panel-body">
                                                <form action="{{ route('admin.managepackagedurations.addPackageDurations') }}"
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    name="duration_name" id="duration_name">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    name="no_ofnights" id="no_ofnights">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
