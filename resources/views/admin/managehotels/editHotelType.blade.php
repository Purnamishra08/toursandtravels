...
<body>
                ...
                <main>
                    <div class="inner-layout">
                        <div class="container-fluid px-4 pt-3">
                            <nav class="tab-menu">
                                <a href="{{ route('admin.manageHoteltype.editHotelType',['id' => $hoteltype->hotel_type_id]) }}" class="tab-menu__item active">
                                    ...
                                    <div class="col-md-12">
                                        <div class="panel panel-bd lobidrag">
                                            <div class="panel-body">
                                                <form action="{{ route('admin.manageHoteltype.editHotelType',['id' => $hoteltype->hotel_type_id]) }}"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    placeholder="Enter Hotel Type" name="hotelType"
                                                                    id="hotelType" value="{{$hoteltype->hotel_type_name}}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
    ...
    <<script>
        function validator(){
        if(!blankCheck('hotelType','Hotel Type cannot be Blank'))
        return false;
        }
        </script>
