                    ...
                    <div class="inner-layout">
                        <div class="container-fluid px-4 pt-3">
                            <nav class="tab-menu">
                                ...
                                <a href="{{ route('admin.manageitineraryenquiry') }}" class="tab-menu__item">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="gap row">
                                                            ...
                                                            <div class="col-md-8">{{$itineraryEnquirys->email}} </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="gap row">
                                                            ...
                                                            <div class="col-md-8">{{$itineraryEnquirys->phone}}</div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="gap row">
                                                            ...
                                                            <div class="col-md-8">
                                                                {{\Carbon\Carbon::parse($itineraryEnquirys->tsdate)->format('jS
                                                                M Y')}}</div>
                                                        </div>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    <div class="col-md-12">
                                                        <div class="gap row">
                                                            ...
                                                            <div class="col-md-10">{{$itineraryEnquirys->duration_name}}</div>
                                                        </div>
                                                    </div>

                                                    <div class="col-md-12">
                                                        <div class="gap row">
                                                            <div class="col-md-2"> <label> Itinerary Enquiry Details </label>
                                                            </div>
                                                            <div class="col-md-10">{{$itineraryEnquirys->tnote}}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    <hr>
                                                    <form
                                                        action="{{ route('admin.manageitineraryenquiry.viewItineraryEnquiry', ['id' => $itineraryEnquirys->tripcust_id]) }}"
                                                        method="POST">
                                                        @csrf
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="hidden" name="hdnenquiry_id"
                                                                    value="{{$itineraryEnquirys->tripcust_id}}">
                                                            </div>
